  ...
  return (
    <div className="description-form__container">
      <div className="description-form__header">
        <h2 className="description-form-heading">Mẫu mô tả gợi ý cho bạn</h2>
      </div>
      <div className="description-form__content">
        ...
        <p className="description-text">
          ...
          ................... Phía Trung tâm Hướng nghiệp - Tư vấn việc làm của
          Trường đã đăng tuyển và cung cấp thông tin ứng viên đến Quý đơn vị.
          Quý Cơ quan/ Doanh nghiệp vui lòng xem thông tin ứng viên bên dưới.
        </p>
        <br />
        <p className="description-text">
          Chúng tôi rất vui mừng trở thành cầu nối hiệu quả với các đối tác nhằm
          tạo việc làm cho người học và sự hợp tác thành công giữa hai bên.
        </p>
