    ...
    <div className="header__with-search">
     <div className="header__with-search-search">
      <div className="header__with-search-search-wrap">
        ...
        <input type="text" className="header__with-search-search-1" required id="none" placeholder="Tìm Kiếm" />
      </div>
      <div className="header__with-search-search-select">
            <IconButton className="select__icon-location">
              <AddLocationIcon />
            </IconButton>
            <span className="header__with-search-search-select-option header__with-search-search-select-option-boder ">
              Khu vực
            </span>
