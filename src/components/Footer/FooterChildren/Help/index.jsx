        ...
        <div className='footer_help'>
          <p className='help_container'>
            ...
            <span className='help_question'>
              - Hiện tại It Jobs mới có những nhóm ngành chính và phổ biến,
              những nhóm ngành ít phổ biến hơn sẽ được nhanh chóng cập nhật sau.
              Bạn có thể đề xuất với chúng tôi qua email (…) về nhóm ngành của
              bạn.
            </span>
          </p>
          <p className='help_container'>
          ...
          <p className='help_container'>
            ...
            <span className='help_question'>
              ...
              <span>
                ...
                <Link to='/forgot-password'>tại đây</Link> hoặc gửi email hỗ trợ
                tới (…)
              </span>
            </span>
          </p>
