...
const Contact = () => {
    ...
    children={<div className='contact'>
        ...
        <p className='contact_company'><span className='contact_company_name'>Số điện thoại: </span> <span>0919 365 363</span></p>
        <p className='contact_company'><span className='contact_company_name'>Email: </span> <span>tuyendung@r2s.com.vn</span></p>
    </div>}
    />
}
