        ...
        <div className="detail__card">
            <div className="detail__card-1">
                <div className="detail__card-intro">
                    <img className="detail__card__logo" alt='detail-card-logo' src="https://r2s.edu.vn/wp-content/uploads/2021/05/r2s.com_.vn_-316x190.png" />
                    <div>
            ...
            <div className="detail__card-5">
                <div>
                    <p>{props.rating}</p>
                    <Rating name="read-only" precision={0.5} readOnly defaultValue={props.star} />
                </div>
                <Button name="Ứng tuyển"></Button>
            </div>
        </div>
