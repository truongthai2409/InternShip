...
export const FOOTER = {
    CONTACT: {
        ...
        content: [
            {
                title: "Trụ sở",
                description: "Lầu 8, Toà Nhà Pearl Plaza, 561A đường Điện Biên Phủ, Phường 25, Quận Bình Thạnh, Thành Phố Hồ Chí Minh",
            },
            {
                title: "Văn phòng",
                description: "A005 Tầng trệt Chung cư Linh Đông, 1164 đường Phạm Văn Đồng, P.Linh Đông, TP Thủ Đức, Thành Phố Hồ Chí Minh",
            },
            {
                title: "Hotline",
