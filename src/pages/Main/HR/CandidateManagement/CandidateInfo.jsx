  ...
  return (
    <div className='candidate'>
      ...
      <div className='candidate_info'>
        <h3>{name}</h3>
        <p>
          Chuyên ngành: <span>{major}</span>
        </p>
        <p>
          Phương thức làm việc: <span>{formality}</span>
        </p>
        <p>
          Số điện thoại: <span>{numberPhone}</span>
        </p>
        <p>
      ...
      <div className='candidate_choise'>
        ...
        <div className='choise'>
          <Button name='Xem CV' onClick={() => setOpen(!open)} />
          {click ? (
            <BookmarkBorderIcon
        ...
        <Modal
          ...
          children={
            <div>
              <img width={'100%'} height={'100%'} src={imageCV}></img>
            </div>
          }
        />
      </div>
